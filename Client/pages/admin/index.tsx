        ...
        <div className="mb-1 w-full mt-4">
          ...
          <div className="block sm:flex items-center md:divide-x md:divide-gray-100">
            ...
            <div className="flex items-center  w-full">
              <button type="button" data-modal-toggle="add-product-modal" className="text-white bg-red-600 hover:bg-yellow-500 focus:ring-4 focus:ring-cyan-200 font-medium inline-flex items-center rounded-lg text-sm px-3 py-2 text-center sm:ml-auto">
